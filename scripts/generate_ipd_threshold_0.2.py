...
KWARGS = [
    ...
    {"lookback": 4, "epsilon": 0.1, "learning_rate": 0.05, "discount_factor": 0.99},
    {"lookback": 5, "epsilon": 0.1, "learning_rate": 0.05, "discount_factor": 0.99},
]

GAME = "IPD-THRESHOLD-0.2"
PAYOFF_MATRIX = None
...
def main():
    ...
    args = [
        (generate_agents, size, 10_000, 10_000, PAYOFF_MATRIX, {}, kwargs, 0.2)
